...
class GraphAnimationUtils(Scene):
    ...
    def show_dfs_intuition(self):
        ...
        new_highlights = self.show_full_dfs_animation(graph, edge_dict, dfs_full_order[:5], order[6:], wait_times,
                                                      wait_time_dict)
        ...
        wait_times[3] = 2
        new_highlights = self.show_full_dfs_animation(graph, edge_dict, dfs_full_order[5:11], order[9:], wait_times,
                                                      wait_time_dict)
        all_highlights.extend(new_highlights)
        self.wait()
        ...
        new_highlights = self.show_full_dfs_animation(graph, edge_dict, dfs_full_order[11:17], order[12:], wait_times,
                                                      wait_time_dict)
        all_highlights.extend(new_highlights)
        ...
        new_highlights = self.show_full_dfs_animation(graph, edge_dict, dfs_full_order[17:], order[-1:], wait_times,
                                                      wait_time_dict)
        all_highlights.extend(new_highlights)
...
class GraphTraversal(GraphAnimationUtils):
    ...
    def show_graph_traversal_term(self, h_line, title):
        ...
        other_nodes = [self.highlight_node(graph, i, animate=False, scale_factor=scale_factor) for i in
                       range(1, len(graph))]
        self.play(
...
class DFSImplementation(GraphAnimationUtils):
    ...
    def visualize_recursion(self, code):
        ...
        all_highlights.extend(
            [surround_circle_0, edge_01, surround_circle_1, edge_13, surround_circle_3, edge_34, surround_circle_4,
             edge_32])
...
class DFSIteratitiveImplementation(GraphAnimationUtils):
    ...
    def iterative_implementation(self):
        ...
        dfs_full_order = dfs(graph, 0)
        wait_times = [0] * len(dfs_full_order)
        new_highlights = self.show_second_dfs_preorder(graph, edge_dict, dfs_full_order[:1], order[1], wait_times,
        ...
        new_highlights = self.show_second_dfs_preorder(graph, edge_dict, dfs_full_order[1:3], order[1][1:], wait_times,
                                                       scale_factor=scale_factor)
        all_highlights.extend(new_highlights)
        ...
        new_highlights = self.show_second_dfs_preorder(graph, edge_dict, dfs_full_order[3:5], order[1][2:], wait_times,
                                                       scale_factor=scale_factor)
        all_highlights.extend(new_highlights)
        ...
        new_highlights = self.show_second_dfs_preorder(graph, edge_dict, dfs_full_order[5:7], order[1][3:], wait_times,
                                                       scale_factor=scale_factor)
        all_highlights.extend(new_highlights)
        ...
        new_highlights = self.show_second_dfs_preorder(graph, edge_dict, dfs_full_order[7:9], order[1][4:], wait_times,
                                                       scale_factor=scale_factor)
        all_highlights.extend(new_highlights)
...
class PostOrder(GraphAnimationUtils):
    ...
    def show_postorder(self):
        ...
        new_highlights = self.show_second_dfs_preorder(graph, edge_dict, dfs_second_full_order[:5], preorder[9:],
                                                       wait_times)
        self.wait(10)
        graph[2].surround_circle.set_color(BRIGHT_RED)
        self.play(
        ...
        new_highlights = self.show_second_dfs_preorder(graph, edge_dict, dfs_second_full_order[5:11], preorder[12:],
                                                       wait_times)
        self.wait()
        graph[6].surround_circle.set_color(BRIGHT_RED)
        self.play(
        ...
        new_highlights = self.show_second_dfs_preorder(graph, edge_dict, dfs_second_full_order[11:-2], preorder[15:-1],
                                                       wait_times)
        self.wait()
        graph[9].surround_circle.set_color(BRIGHT_RED)
        self.play(
        ...
        new_highlights = self.show_second_dfs_preorder(graph, edge_dict, dfs_second_full_order[-2:], preorder[-1:],
                                                       wait_times)
        all_highlights.extend(new_highlights)
        self.wait()
        graph[4].surround_circle.set_color(BRIGHT_RED)
...
class DFSApplications(GraphAnimationUtils):
    ...
    def show_topological_sort(self, h_line):
        ...
        surround_circles = [self.highlight_node(graph, i, scale_factor=scale_factor, animate=False) for i in
                            range(len(graph))]
...
class MazeGeneration(GraphAnimationUtils):
    ...
    def make_graph_from_grid(self, grid):
        ...
        for i in range(len(grid) - 1):
            for j in range(len(grid[0])):
                edge_dict[(i * len(grid[0]) + j, (i + 1) * len(grid[0]) + j)] = graph[i * len(grid[0]) + j].connect(
                    graph[(i + 1) * len(grid[0]) + j])
...
class Logo(Scene):
    def construct(self):
        ...
        triangle = RegularPolygonDepreciated(color=LIGHT_VIOLET, fill_color=LIGHT_VIOLET, fill_opacity=1,
                                             sheen_factor=0.2)
